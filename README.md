...
![ARGUS console](artifacts/screenshots/01-triage.png)
...
The [v1.0.0 release](https://github.com/munisaparji/argus-cctv/releases/tag/v1.0.0) includes the complete project ZIP with its built console, the PDF guide, editable presentation, poster and captioned demo video. The adjacent SHA256 file verifies the ZIP. Sign in with repository access to download this private release.

The Git repository contains the source, synthetic samples, documentation and tests. The large ZIP and walkthrough video are release assets; build the console with the setup commands below when cloning the repository.
...
If PowerShell blocks local scripts, run the equivalent commands in [docs/SETUP.md](docs/SETUP.md). No machine-wide execution-policy change is required.
...
- [Executed checks](docs/TEST_REPORT.md)
- [Release contents and demo recording](docs/RELEASE_NOTES.md)
- [Research workflows](docs/RESEARCH_WORKFLOWS.md)
- [Input formats](docs/DATA_FORMATS.md)
- [Annotation codebook](docs/SIRB_ANNOTATION_PROTOCOL.md)
- [Ethics and model licences](docs/ETHICS.md)
- [Verified literature metadata](docs/literature/verified.json)
- [Phase completion and limitations](docs/COMPLETION_STATUS.md)
- [Viva preparation](docs/VIVA_PREP.md)
